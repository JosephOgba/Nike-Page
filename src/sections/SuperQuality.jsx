...
const SuperQuality = () => {
  return (
   ...
   <div className='flex flex-1 flex-col'>
      ...
      <p className='mt-4 lg:max-w-lg info-text'>Ensuring premium comfort and style, our meticulously crafted footwear is designed to elevate your experinc, providing you with unmatched quality, innovation, and a touch of elegance.</p>
